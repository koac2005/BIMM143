...
> Q3: What is your favorite candy in the dataset and what’s its
> winpercent value?
...
A: P value is 2.871e-08 \<\<\< 0.05, so the difference is statistically
significant
...
A: fruity, hard, and pluribus are picked up strongly by PC1 in the
positive direction. This makes sense, as popular candies like Starburst,
Nerds, and Skittles, fulfill many of these qualities if not all three.
